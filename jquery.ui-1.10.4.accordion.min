...
(function (e, t) {
    ...
    e.widget.extend             = function (i) {
        for (var a, n, r = s.call(arguments, 1), o = 0, h = r.length; h > o; o++) 
            for (a in r[o]) 
                n = r[o][a],
                r[o].hasOwnProperty(a) && n !== t && (i[a] = e.isPlainObject(n)
                    ? e.isPlainObject(i[a])
    ...
    e.Widget.prototype          = {
        ...
        _createWidget      : function (t, s) {
            ...
            s !== this && (e.data(s, this.widgetFullName, this), this._on(!0, this.element, {
                ...
                ? s.ownerDocument
                : s.document || s), this.window = e(this.document[0].defaultView || this.document[0].parentWindow)),
            this._create(),
...
(function (e) {
    ...
    e.widget("ui.accordion", {
        _activate          : function (t) {
            ...
            i !== this.active[0] && (i = i || this.active[0], this._eventHandler({currentTarget: i, preventDefault: e.noop, target: i}))
        },
                ...
                ? e.length
                    ? (n = e.show().outerHeight(), t.animate(i, {
                        ...
                        step    : function (e, i) {
                            ...
                            "height" !== i.prop
                                ? l += i.now
                                : "content" !== h.options.heightStyle && (i.now = Math.round(n - t.outerHeight() - l), l = 0)
                        }
                    }), undefined)
                    : t.animate(i, o, r, p)
                : e.animate(s, o, r, p)
        ...
        _destroy           : function () {
            ...
            this
                .headers
                .removeClass("ui-accordion-header ui-accordion-header-active ui-helper-reset ui-state-default " +
            ...
            e = this
                ...
                .removeClass("ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content ui-accor" +
                        "dion-content-active ui-state-disabled")
                .each(function () {
                    /^ui-accordion/.test(this.id) && this.removeAttribute("id")
                }),
        ...
        _eventHandler      : function (t) {
            ...
            n && !i.collapsible || this._trigger("beforeActivate", t, l) === !1 || (i.active = r
                ? !1
                : this.headers.index(a), this.active = n
                ? e()
        ...
        _refresh           : function () {
            ...
            "fill" === a
                ? (i = n.height(), this.element.siblings(":visible").each(function () {
                    var t = e(this),
                        s = t.css("position");
                ...
                : "auto" === a && (i = 0, this.headers.next().each(function () {
        ...
        _setOption         : function (e, t) {
            return "active" === e
                ...
                : ("event" === e && (this.options.event && this._off(this.headers, this.options.event), this._setupEvents(t)), this._super(e, t), "collapsible" !== e || t || this.options.active !== !1 || this._activate(0), "icons" === e && (this._destroyIcons(), t && this._createIcons()), "disabled" === e && this.headers.add(this.headers.next()).toggleClass("ui-state-disabled", !!t), undefined)
        },
...
(function (e, t) {
    ...
    function (e, t) {
        ...
        var n,
            r = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColo" +
                  "r color columnRuleColor outlineColor textDecorationColor textEmphasisColor",
            o = /^([\-+])=\s*(\d+\.?\d*)/,
            h = [
                {
                    parse: function (e) {
            ...
            transition  : function (e, t) {
                ...
                m(n.props, function (e, a) {
                    ...
                    null !== l && (null === r
                        ...
                        : (u.mod && (l - r > u.mod / 2
                            ? r += u.mod
                            : r - l > u.mod / 2 && (r -= u.mod)), h[n] = i((l - r) * t + r, a)))
                }),
                this[a](h)
            }
        }),
        ...
        m(u, function (s, a) {
            ...
            m(n, function (t, i) {
                l.fn[t] || (l.fn[t] = function (a) {
                    ...
                    return "undefined" === r
                        ? u
                        : ("function" === r && (a = a.call(this, u), r = e.type(a)), null == a && i.empty
                            ? this
                            : ("string" === r && (n = o.exec(a), n && (a = u + parseFloat(n[2]) * ("+" === n[1]
                                ? 1
    ...
    function () {
        ...
        e.extend(e.effects, {
            createWrapper: function (t) {
                ...
                var i = {
                    ...
                    s = e("<div></div>")
                        ...
                        .css({background: "transparent", border: "none", fontSize: "100%", margin: 0, padding: 0}),
                    a = {
                        height: t.height(),
                        width : t.width()
                    },
                ...
                "static" === t.css("position")
                    ...
                    }), t.css({bottom: "auto", left: 0, position: "relative", right: "auto", top: 0})),
                t.css(a),
                s
                    .css(i)
                    .show()
            ...
            removeWrapper: function (t) {
                ...
                return t
                    .parent()
                    .is(".ui-effects-wrapper") && (t.parent().replaceWith(t), (t[0] === i || e.contains(t[0], i)) && e(i).focus()),
                t
            },
